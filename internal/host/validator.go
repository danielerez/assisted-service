...
func (v *validator) isMachineCidrDefined(c *validationContext) validationStatus {
	return boolValue(swag.StringValue(c.cluster.Kind) == models.ClusterKindClusterDay2 || c.cluster.MachineNetworkCidr != "")
}
...
func (v *validator) belongsToMachineCidr(c *validationContext) validationStatus {
	if swag.StringValue(c.cluster.Kind) == models.ClusterKindClusterDay2 {
		return ValidationSuccess
	}
